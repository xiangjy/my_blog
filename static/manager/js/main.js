...
/* console 信息 */
console.log("%c向京阳的博客 %c Copyright \xa9 2015-%s",'font-family: "Helvetica Neue", Helvetica, Arial, sans-serif;font-size:30px;-webkit-text-fill-color:#758EB7;-webkit-text-stroke: 1px #758EB7;',"font-size:12px;color:#999999;",(new Date).getFullYear())
console.log("%cヾﾉ≧∀≦)o来啊，快活啊!", "color:#e1244e;font-size:14px;text-shadow:3px 1px 2px #e1244e9e;")
console.log("%c ", "background: url(https://blog.mmdry.com/static/manager/images/code.png) no-repeat center;padding-left:640px;padding-bottom: 242px;")
